...
namespace SoundCloud.API.Client
{
    public class SoundCloudConnector : ISoundCloudConnector
    {
        ...
        public async Task<ISoundCloudClient> DirectConnect(string clientId, string clientSecret, string userName, string password)
        {
            var credentials = new SCCredentials
            {
                ClientId = clientId,
            ...
            var accessToken = await authApi.AuthorizeByPassword(userName, password);
        ...
        public async Task<ISoundCloudClient> Connect(string clientId, string clientSecret, string code, string redirectUri)
        {
            var credentials = new SCCredentials
            {
                ClientId = clientId,
            ...
            IAuthApi authApi = CreateAuthApi(soundCloudRawClient);
            var accessToken = await authApi.AuthorizeByCode(code, redirectUri);
        ...
        public async Task<SCAccessToken> RefreshToken(string clientId, string clientSecret, string token)
        {
            var credentials = new SCCredentials
            {
                ClientId = clientId,
