...
namespace SoundCloud.API.Client.Subresources.Helpers
{
    public class TracksSearcher : ITracksSearcher
    {
        ...
        private readonly Func<Dictionary<string, object>, Task<SCTrack[]>> search;
        private readonly Dictionary<string, object> searchParameters;

        internal TracksSearcher(SCFilter filter, IPaginationValidator paginationValidator, Func<Dictionary<string, object>, Task<SCTrack[]>> search)
        {
        ...
        public async Task<SCTrack[]> Exec(SCOrder order, int offset, int limit)
        {
