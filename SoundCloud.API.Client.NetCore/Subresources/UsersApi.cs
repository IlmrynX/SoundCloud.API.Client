...
namespace SoundCloud.API.Client.Subresources
{
    public class UsersApi : IUsersApi
    {
        ...
        public async Task<SCUser[]> SearchUsers(string query, int offset = 0, int limit = 50)
        {
            ...
            var users = await soundCloudRawClient.Request<User[]>(prefix, string.Empty, HttpMethod.Get, parameters: parameters.SetPagination(offset, limit));
