...
namespace SoundCloud.API.Client.Subresources
{
    ...
    {
        Task<SCApplication> GetApplication();
    ...
    public class AppApi : IAppApi
    {
        ...
        public async Task<SCApplication> GetApplication()
        {
            var application = await soundCloudRawClient.Request<Application>(prefix, string.Empty, HttpMethod.Get);
