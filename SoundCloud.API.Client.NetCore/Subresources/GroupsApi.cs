...
namespace SoundCloud.API.Client.Subresources
{
    public class GroupsApi : IGroupsApi
    {
        ...
        public async Task<SCGroup[]> Search(string query, int offset = 0, int limit = 50)
        {
            ...
            var groups = await soundCloudRawClient.Request<Group[]>(prefix, string.Empty, HttpMethod.Get, parameters.SetPagination(offset, limit));
