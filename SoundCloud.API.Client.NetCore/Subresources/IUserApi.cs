...
namespace SoundCloud.API.Client.Subresources
{
    ...
    {
        Task<SCUser> UpdateUser(SCUser user);
        Task<SCUser> GetUser();
        ...
        Task PutFollowing(string followingUserId);
        Task DeleteFollowing(string followingUserId);
        ...
        Task PutFavorite(string favoriteTrackId);
        Task DeleteFavorite(string favoriteTrackId);
